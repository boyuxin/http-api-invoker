...
public class SqlTest {
    public static void main(String[] args) {
        ...
        String s2 = "INSERT INTO `fosun_health`.`t_consult_business_group_member` ( `doctor_id`, `doctor_name`, `doctor_role`, `group_id`, `created_at`, `created_by`, `updated_at`, `updated_by`, `usable_flag`) VALUES ( 'doctorId', 'doctorName', 'DOCTOR_ASSISTANT', 'group_55', '2022-12-14 00:00:00', 'SYS', '2022-12-14 00:00:00', 'SYS', 'USABLE');\n";
